...
param(
    [string]$ZipPath='D:\SOODALLIFE\SoodalLife-ProviderAutomaticRematching-20260828-v151.zip',
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases',
    [switch]$ConfirmProductionDeployment
)
$ErrorActionPreference='Stop'
$expectedSha256='3592D8B0553D9E1BE59812726CD116D6A8CCE87D95E31BA90797A16D30F304B8'
...
$extractPath=Join-Path $ReleaseBasePath "provider-automatic-rematching-v151-$stamp"
...
Write-Host "2/4 Extracted V151 deployment validated: $release"
...
Write-Host '4/4 V151 automatic provider rematching deployment completed.' -ForegroundColor Green
