...
param(
    [string]$ZipPath='D:\SOODALLIFE\SoodalLife-ProviderRealtimeInbox-20260827-v147.zip',
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases',
    [switch]$ConfirmProductionDeployment
)
$ErrorActionPreference='Stop'
$expectedSha256='D9BB9C539F467AA0408E02F716E9958237812DF487157C642160E40C7808AE3A'
...
$extractPath=Join-Path $ReleaseBasePath "provider-realtime-inbox-v147-$stamp"
...
Write-Host "2/4 Extracted V147 deployment validated: $release"
...
Write-Host '4/4 V147 provider realtime inbox deployment completed.' -ForegroundColor Green
