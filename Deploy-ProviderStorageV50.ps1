[CmdletBinding()]
param(
    [string]$ZipPath = 'D:\SOODALLIFE\SoodalLife-ProviderStorage-20260817-2e647b5-v50.zip',
    [string]$ReleaseBasePath = 'D:\SOODALLIFE\releases'
)

$ErrorActionPreference = 'Stop'
$expectedSha256 = '0138204FF695192DC40FF2C824CC5AFC7A640AAF2F69F1F74A60491D6A6E91F5'
...
$extractPath = Join-Path $ReleaseBasePath "provider-storage-v50-$stamp"
...
Write-Host 'Next: hard refresh and verify storage status, logo/photo upload, API health and readiness.'
