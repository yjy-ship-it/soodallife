...
param(
    [string]$ZipPath='D:\SOODALLIFE\SoodalLife-CustomerUnifiedProgress-20260824-v130.zip',
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases',
    [switch]$ConfirmProductionDeployment
)
$ErrorActionPreference='Stop'
$expectedSha256='C9950391BC1B733BD68FE0ACD495F08977CCCA034879382C588624E5F5D4433A'
...
$extractPath=Join-Path $ReleaseBasePath "customer-unified-progress-v130-$stamp"
...
$required=Join-Path $release 'frontend\customer\index.html'
if(-not(Test-Path -LiteralPath $required -PathType Leaf)){throw "Required deployment file is missing: $required"}
Write-Host "2/4 Extracted V130 deployment validated: $release"
Write-Host '3/4 Running protected customer frontend backup and IIS deployment.'
...
Write-Host '4/4 V130 unified customer progress deployment completed.' -ForegroundColor Green
