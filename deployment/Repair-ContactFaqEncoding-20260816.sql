...
IF NOT EXISTS (
    ...
    WHERE MigrationId = N'20260816164000_RepairContactFaqEncoding'
)
BEGIN
    ...
    IF @@ROWCOUNT <> 1
        THROW 51000, 'Privacy FAQ row was not updated.', 1;
    ...
    IF @@ROWCOUNT <> 1
        THROW 51001, 'Customer center FAQ row was not updated.', 1;

    INSERT INTO dbo.__EFMigrationsHistory (MigrationId, ProductVersion)
    VALUES (N'20260816164000_RepairContactFaqEncoding', N'10.0.10');
END;
