...
$backupRoot = Join-Path $backupParent "backup-before-trust-policy-v62-$stamp"
$iisBackupName = "Before_TrustPolicyV62_$stamp"
...
Write-Host 'Next: sign in as Admin and activate the reviewed trust policy, then verify review-driven recalculation.'
