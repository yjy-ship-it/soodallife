...
$backupRoot=Join-Path $BackupParent "backup-before-spa-routing-recovery-v111-$stamp"
$iisBackupName="Before_SpaRoutingRecoveryV111_$stamp"
$sources=[ordered]@{
...
Write-Host 'V111 SPA routing recovery deployment completed.' -ForegroundColor Green
