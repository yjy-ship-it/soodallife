...
$backupRoot=Join-Path $BackupParent "backup-before-customer-mobile-gutter-v112-$stamp"
$iisBackupName="Before_CustomerMobileGutterV112_$stamp"
$sources=[ordered]@{
...
$checks=[ordered]@{
    ...
    AdminCompany='https://admin.soodallife.kr/company'
}
...
Write-Host 'V112 customer mobile gutter deployment completed.' -ForegroundColor Green
