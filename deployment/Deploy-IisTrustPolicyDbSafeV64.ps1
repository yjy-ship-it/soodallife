...
$backupRoot = Join-Path $backupParent "backup-before-trust-policy-db-safe-v64-$stamp"
$iisBackupName = "Before_TrustPolicyDbSafeV64_$stamp"
...
Write-Host 'Next: Admin > Trust Policy > safely register default policy data, then save, approve, and activate the draft.'
