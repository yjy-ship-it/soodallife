...
$backupRoot=Join-Path $BackupParent "backup-before-portal-navigation-v109-$stamp"
$iisBackupName="Before_PortalNavigationV109_$stamp"
$sources=[ordered]@{
...
Write-Host 'V109 portal navigation deployment completed.' -ForegroundColor Green
