...
if(-not $PSCmdlet.ShouldProcess("API and customer apps at $AppsRoot",'Deploy V133-R2 customer live activity SQL query fix')){return}
Import-Module WebAdministration
$releaseRoot=$PSScriptRoot
$stamp=Get-Date -Format 'yyyyMMdd-HHmmss'
$backupRoot=Join-Path $BackupParent "backup-before-customer-live-activity-v133-r2-$stamp"
$iisBackupName="Before_CustomerLiveActivityV133R2_$stamp"
...
Write-Host 'V133-R2 customer live activity SQL query fix deployment completed.' -ForegroundColor Green
