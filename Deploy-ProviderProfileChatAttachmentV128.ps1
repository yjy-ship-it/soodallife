...
param(
    [string]$ZipPath='D:\SOODALLIFE\SoodalLife-ProviderProfileChatAttachment-20260824-v128.zip',
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases',
    [switch]$ConfirmProductionDeployment
)
$ErrorActionPreference='Stop'
$expectedSha256='D3CEDF845E084C53DB6AED192FC9CAA9CF2B6FB824A46901327BECD3BF488EF0'
...
$extractPath=Join-Path $ReleaseBasePath "provider-profile-chat-attachment-v128-$stamp"
...
Write-Host "2/4 Extracted V128 deployment validated: $release"
...
Write-Host '4/4 V128 provider profile and reliable chat attachment deployment completed.' -ForegroundColor Green
