[CmdletBinding()]
param(
    [string]$ZipPath='D:\SOODALLIFE\SoodalLife-SpaRoutingRecovery-20260820-v111.zip',
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases'
)
$ErrorActionPreference='Stop'
$expectedSha256='83AF4BF354B8EA379B1689CBF95B1BCDCD6C0112F70107D2E0AC254F05DC2FCA'
...
$extractPath=Join-Path $ReleaseBasePath "spa-routing-recovery-v111-$stamp"
...
Write-Host '4/4 V111 deployment completed.' -ForegroundColor Green
