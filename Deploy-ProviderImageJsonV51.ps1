[CmdletBinding()]
param(
    [string]$ZipPath = 'D:\SOODALLIFE\SoodalLife-ProviderImageJson-20260817-2e647b5-v51.zip',
    [string]$ReleaseBasePath = 'D:\SOODALLIFE\releases'
)

$ErrorActionPreference = 'Stop'
$expectedSha256 = 'AF3A833D2C497619247E1297C940F1D3D61E26BA00606E880FF5F87D9DE55F8B'
...
$extractPath = Join-Path $ReleaseBasePath "provider-image-json-v51-$stamp"
...
Write-Host 'Next: hard refresh and verify JSON logo/photo upload, API health and readiness.'
