...
param(
    [string]$ZipPath='D:\SOODALLIFE\SoodalLife-ProviderOnboardingContinuation-20260828-v150.zip',
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases',
    [switch]$ConfirmProductionDeployment
)
$ErrorActionPreference='Stop'
$expectedSha256='285608057AB023F33ACC3BA8F527C8374C27C8EB4B3D48474FD2D3BB41E3C771'
...
$extractPath=Join-Path $ReleaseBasePath "provider-onboarding-continuation-v150-$stamp"
...
Write-Host "2/4 Extracted V150 deployment validated: $release"
...
Write-Host '4/4 V150 provider onboarding continuation deployment completed.' -ForegroundColor Green
