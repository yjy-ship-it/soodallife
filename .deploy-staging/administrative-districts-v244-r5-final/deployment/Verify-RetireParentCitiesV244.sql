...
) THROW 52441, 'V244-R5 verification failed: one or more parent city rows still exist.', 1;
...
) THROW 52442, 'V244-R5 verification failed: one or more district choices were removed or assigned incorrectly.', 1;
