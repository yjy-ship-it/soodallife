...
$marker=(Get-Content -LiteralPath (Join-Path $targets.API 'V243-API-MARKER.txt') -Raw -Encoding UTF8).Contains('V243 provider workflow and catalog fixes: enabled')
...
Write-Host 'V243 administrative district catalog deployment completed.' -ForegroundColor Green
