...
BEGIN TRY
    ...
    IF (SELECT COUNT(*) FROM #TargetCities)<>13
        THROW 52443, 'V244-R2 apply failed: exactly 13 parent city rows must exist before deletion.', 1;
    ...
    BEGIN
        ...
        BEGIN
            DECLARE @ReferenceError nvarchar(2048)=N'V244-R2 deletion stopped: a target city is referenced by '+@ReferenceTable+N'.';
    ...
    IF @@ROWCOUNT<>13
        THROW 52445, 'V244-R2 apply failed: deleted city count was not 13.', 1;
