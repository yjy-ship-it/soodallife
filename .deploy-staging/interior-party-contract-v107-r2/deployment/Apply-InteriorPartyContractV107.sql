...
BEGIN TRY
 ...
 BEGIN
  ...
  END;
  IF NOT EXISTS(SELECT 1 FROM sys.foreign_keys WHERE name=N'FK_interior_projects_provider_wallets_fee_reservation_wallet_id') EXEC sys.sp_executesql N'ALTER TABLE dbo.interior_projects ADD CONSTRAINT FK_interior_projects_provider_wallets_fee_reservation_wallet_id FOREIGN KEY(fee_reservation_wallet_id) REFERENCES dbo.provider_wallets(id);';
