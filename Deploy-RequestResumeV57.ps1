[CmdletBinding()]
param(
    [string]$ZipPath = 'D:\SOODALLIFE\SoodalLife-RequestResume-20260818-2e647b5-v57.zip',
    [string]$ReleaseBasePath = 'D:\SOODALLIFE\releases'
)

$ErrorActionPreference = 'Stop'
$expectedSha256 = '33558F472423796D57E7E008380EAC2CF1377090AB96926FE7C9383A1AC84C7F'
...
$extractPath = Join-Path $ReleaseBasePath "request-resume-v57-$stamp"
...
Write-Host 'Next: hard refresh and verify resumed request navigation, expired schedule guidance, provider profile images and request attachment previews.'
