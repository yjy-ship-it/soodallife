...
param(
    [string]$ZipPath='D:\SOODALLIFE\SoodalLife-CustomerLiveActivity-20260824-v129-r2.zip',
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases',
    [switch]$ConfirmProductionDeployment
)
$ErrorActionPreference='Stop'
$expectedSha256='1026459C4AFBCDB38EC4371CA831ED1ACD7204E092E0BB7EFE8FE8C8FA401841'
...
$extractPath=Join-Path $ReleaseBasePath "customer-live-activity-v129-r2-$stamp"
...
Write-Host "2/4 Extracted V129-R2 deployment validated: $release"
...
Write-Host '4/4 V129-R2 customer live activity SQL fix deployment completed.' -ForegroundColor Green
