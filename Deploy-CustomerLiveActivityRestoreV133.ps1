...
param(
    [string]$ZipPath='D:\SOODALLIFE\SoodalLife-CustomerLiveActivityRestore-20260825-v133.zip',
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases',
    [switch]$ConfirmProductionDeployment
)
$ErrorActionPreference='Stop'
$expectedSha256='0ADD2F111A8EF8898F5BF740F383348C979BDF3D07ED64B7402051D07D4A06E8'
...
$extractPath=Join-Path $ReleaseBasePath "customer-live-activity-restore-v133-$stamp"
...
Write-Host "2/4 Extracted V133 deployment validated: $release"
...
Write-Host '4/4 V133 customer live activity restoration deployment completed.' -ForegroundColor Green
