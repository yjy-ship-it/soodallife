...
param(
    [string]$ZipPath='D:\SOODALLIFE\SoodalLife-ChatAttachmentJson-20260825-v135.zip',
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases',
    [switch]$ConfirmProductionDeployment
)
$ErrorActionPreference='Stop'
$expectedSha256='23CA002168592C5158A1A8E7E0DB16E7FE8A9F6449E49C45A3D7BE0047986321'
...
$extractPath=Join-Path $ReleaseBasePath "chat-attachment-json-v135-$stamp"
...
Write-Host "2/4 Extracted V135 deployment validated: $release"
...
Write-Host '4/4 V135 JSON chat attachment deployment completed.' -ForegroundColor Green
