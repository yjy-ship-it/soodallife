...
param(
    [string]$ZipPath='D:\SOODALLIFE\SoodalLife-CustomerLiveActivity-20260824-v129.zip',
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases',
    [switch]$ConfirmProductionDeployment
)
$ErrorActionPreference='Stop'
$expectedSha256='F5D6A8E964CBE5CF0DE3F9034E42A31D9B7B3AC9EDF02C09743F09B2E1B84155'
...
$extractPath=Join-Path $ReleaseBasePath "customer-live-activity-v129-$stamp"
...
Write-Host "2/4 Extracted V129 deployment validated: $release"
...
Write-Host '4/4 V129 customer live activity deployment completed.' -ForegroundColor Green
