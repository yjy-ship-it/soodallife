...
param(
    [string]$ZipPath='D:\SOODALLIFE\SoodalLife-ChatAttachmentChunks-20260825-v137.zip',
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases',
    [switch]$ConfirmProductionDeployment
)
$ErrorActionPreference='Stop'
$expectedSha256='20611A1519FCD5858FDE7660049B2F81F91953BB30C9354D9636CB52BD3C973F'
...
$extractPath=Join-Path $ReleaseBasePath "chat-attachment-chunks-v137-$stamp"
...
Write-Host "2/4 Extracted V137 deployment validated: $release"
Write-Host '3/4 Running protected API/frontend backup, private storage ACL and chunked attachment deployment.'
...
Write-Host '4/4 V137 chunked chat attachment deployment completed.' -ForegroundColor Green
