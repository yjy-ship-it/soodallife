[CmdletBinding()]
param(
    [string]$ZipPath = 'D:\SOODALLIFE\SoodalLife-ManagedContentDefaults-20260819-9705638-v97.zip',
    [string]$ReleaseBasePath = 'D:\SOODALLIFE\releases'
)

$ErrorActionPreference = 'Stop'
$expectedSha256 = '9562E9FD2D953C822F551A7BDA515D2C272C8329EB04ECF854B65F72446AD588'
...
$extractPath = Join-Path $ReleaseBasePath "managed-content-defaults-v97-$stamp"
...
Write-Host 'Next: verify five safety guides, five service guides, five price references, advertising workflow, and placements.'
