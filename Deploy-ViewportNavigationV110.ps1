[CmdletBinding()]
param(
    [string]$ZipPath='D:\SOODALLIFE\SoodalLife-ViewportNavigation-20260820-v110.zip',
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases'
)
$ErrorActionPreference='Stop'
$expectedSha256='7EC8B27C8C7B8579ED20DDBB95B1F8B5F577089023139F19CA9D5C575B6108F5'
...
$extractPath=Join-Path $ReleaseBasePath "viewport-navigation-v110-$stamp"
...
Write-Host '4/4 V110 deployment completed.' -ForegroundColor Green
