[CmdletBinding()]
param(
    [string]$ZipPath = 'D:\SOODALLIFE\SoodalLife-ProviderWallet-20260817-2e647b5-v45.zip',
    [string]$ReleaseBasePath = 'D:\SOODALLIFE\releases'
)

$ErrorActionPreference = 'Stop'
$expectedSha256 = 'CD2F8DF16B36F75C7CF296E81477CFA84278DF581ACC19E0148521EF7A77A8D4'
...
$extractPath = Join-Path $ReleaseBasePath "provider-wallet-v45-$stamp"
...
Write-Host 'Next: verify HTTPS pages, login, API health and readiness.'
