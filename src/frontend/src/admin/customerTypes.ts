...
export interface AdminCustomerDetail {
  ...
  requests: Array<{ id: string; title: string; serviceName: string; createdAt: string; statusCode: string; areaName: string; detailAddress: string | null; quoteCount: number; hasAcceptedQuote: boolean }>
