...
export function CompanyInfoPage() {
  return <CustomerAppLayout><section className="pageHeading"><p>회사정보</p><h1>회사소개</h1></section><section className="publicContentDetail"><h2>운영 콘텐츠 준비 중</h2><p>승인된 회사소개 콘텐츠가 아직 등록되지 않았습니다. 임의 소개문을 운영 정보처럼 표시하지 않습니다.</p></section></CustomerAppLayout>
}
