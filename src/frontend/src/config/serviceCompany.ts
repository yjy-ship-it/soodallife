...
export const serviceCompany = {
  ...
  privacyEmail: 'soodallife@dh9.kr' as string | null,
  platformNotice:
    '수달 라이프는 고객과 서비스 전문가를 연결하는 생활서비스 플랫폼입니다. 서비스 계약 및 작업 수행의 당사자 관계는 개별 서비스의 거래 형태와 계약 조건에 따라 달라질 수 있습니다.',
...
export const servicePolicyLinks: readonly ServicePolicyLink[] = [
  ...
  { label: '일반결제 환불정책', href: '/policies/general-payment-refund', emphasized: true },
  { label: '정기구독 환불정책', href: '/policies/subscription-refund', emphasized: true },
