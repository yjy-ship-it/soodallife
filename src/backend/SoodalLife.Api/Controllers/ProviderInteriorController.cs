...
public sealed class ProviderInteriorController(ProviderInteriorService service):ControllerBase
{
    ...
    [HttpPost("projects/{id:guid}/site-visit-proposals")] public Task<ActionResult<ProviderInteriorDetail>> ProposeVisit(Guid id,ProposeProviderInteriorSiteVisitRequest input,CancellationToken t)=>Run(()=>service.ProposeSiteVisit(id,input,User,t));
    ...
    [HttpPost("projects/{id:guid}/contract-records")] public Task<ActionResult<ProviderInteriorDetail>> ContractRecord(Guid id,RegisterInteriorContractRecordRequest input,CancellationToken t)=>Run(()=>service.RegisterContract(id,input,User,t));
    ...
    [HttpPost("projects/{id:guid}/stages")] public Task<ActionResult<ProviderInteriorDetail>> CreateStage(Guid id,CreateInteriorWorkStageRequest input,CancellationToken t)=>Run(()=>service.CreateStage(id,input,User,t));
