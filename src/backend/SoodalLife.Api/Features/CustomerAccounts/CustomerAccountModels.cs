...
public sealed record SaveCustomerAddressRequest([param: Required, StringLength(100)] string AddressName, [param: StringLength(100)] string? RecipientName, [param: StringLength(10)] string? PostalCode, [param: StringLength(500)] string? RoadAddress, [param: StringLength(500)] string? DetailAddress, [param: Required] Guid? AdministrativeAreaId, decimal? Latitude, decimal? Longitude, bool IsDefault, string? ConcurrencyToken);
