...
[Migration("20260816144500_RepairProviderRegistrationLegalDocuments")]
public partial class RepairProviderRegistrationLegalDocuments : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql("""
            ...
            BEGIN
                ...
                IF EXISTS(SELECT 1 FROM legal_document_versions WHERE public_id=@VersionPublicId)
                BEGIN
            ...
            IF (SELECT COUNT(*) FROM legal_documents WHERE code IN
