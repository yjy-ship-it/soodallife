[CmdletBinding()]
param(
    [string]$ZipPath = 'D:\SOODALLIFE\SoodalLife-ProviderImageRecovery-20260818-2e647b5-v54.zip',
    [string]$ReleaseBasePath = 'D:\SOODALLIFE\releases'
)

$ErrorActionPreference = 'Stop'
$expectedSha256 = 'D9234504B8630939A506E0E2BA3DECA1D313570ECA4927A4C88A3F9D92847F6D'
...
$extractPath = Join-Path $ReleaseBasePath "provider-image-recovery-v54-$stamp"
...
Write-Host 'Next: hard refresh and verify recovered logo/photo upload, API health and readiness.'
