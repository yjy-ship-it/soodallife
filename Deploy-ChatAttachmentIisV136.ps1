...
param(
    [string]$ZipPath='D:\SOODALLIFE\SoodalLife-ChatAttachmentIis-20260825-v136.zip',
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases',
    [switch]$ConfirmProductionDeployment
)
$ErrorActionPreference='Stop'
$expectedSha256='569A7BE688965E7A87A7C6994F9FB3986E12093E38760A992C7CEDC19A415DB7'
...
$extractPath=Join-Path $ReleaseBasePath "chat-attachment-iis-v136-$stamp"
...
Write-Host "2/4 Extracted V136 deployment validated: $release"
Write-Host '3/4 Running protected API/frontend backup, private storage ACL and IIS upload-limit deployment.'
...
Write-Host '4/4 V136 IIS chat attachment upload deployment completed.' -ForegroundColor Green
