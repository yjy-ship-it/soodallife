[CmdletBinding()]
param(
    [string]$ZipPath = 'D:\SOODALLIFE\SoodalLife-SubscriptionBilling-20260819-9705638-v100.zip',
    [string]$ReleaseBasePath = 'D:\SOODALLIFE\releases'
)

$ErrorActionPreference = 'Stop'
$expectedSha256 = '3096AF773CF7AB512E79D91E9B8A8E371D53C89F7F616A1F9FA35E730F882AFD'
...
$extractPath = Join-Path $ReleaseBasePath "subscription-billing-v100-$stamp"
...
$requiredFiles = @(
    ...
    (Join-Path $releasePath 'deployment\Apply-SubscriptionBillingV100.sql'),
    (Join-Path $releasePath 'deployment\Verify-SubscriptionBillingV100.sql')
)
...
Write-Host 'Next: verify first-payment pending, recurring consent, activation after payment, retry, cancellation, and paid-visit settlement.'
