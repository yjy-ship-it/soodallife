...
param(
    [string]$ZipPath='D:\SOODALLIFE\SoodalLife-ChatAttachment-20260823-v125.zip',
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases',
    [switch]$ConfirmProductionDeployment
)
$ErrorActionPreference='Stop'
$expectedSha256='2FD9E68F2E32261B4A2240B7482AF4E7D56BB398456A2B36F6E48763E300E758'
...
$extractPath=Join-Path $ReleaseBasePath "chat-attachment-v125-$stamp"
...
Write-Host "2/4 Extracted V125 deployment validated: $release"
...
Write-Host '4/4 V125 chat attachment deployment completed.' -ForegroundColor Green
