...
param(
    [string]$ZipPath='D:\SOODALLIFE\SoodalLife-ChatFileOpen-20260825-v140.zip',
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases',
    [switch]$ConfirmProductionDeployment
)
$ErrorActionPreference='Stop'
$expectedSha256='48D56ACBCFB47978A1961BF7EC898A3BC3D1B250CE60B8D674FB7C99B22A4D52'
...
$extractPath=Join-Path $ReleaseBasePath "chat-file-open-v140-$stamp"
...
Write-Host "2/4 Extracted V140 deployment validated: $release"
...
Write-Host '4/4 V140 authenticated chat file link deployment completed.' -ForegroundColor Green
