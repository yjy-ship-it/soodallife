[CmdletBinding()]
param(
    [string]$ZipPath = 'D:\SOODALLIFE\SoodalLife-ReportTypeDefaults-20260818-9705638-v95.zip',
    [string]$ReleaseBasePath = 'D:\SOODALLIFE\releases'
)

$ErrorActionPreference = 'Stop'
$expectedSha256 = '82E8BB3E955B21F59C9A8470AD9819382660210492EDE28C5208068DC4BBB457'
...
$extractPath = Join-Path $ReleaseBasePath "report-type-defaults-v95-$stamp"
...
Write-Host 'Next: verify the ten default report types and the safe initialization button in the admin case-master page.'
