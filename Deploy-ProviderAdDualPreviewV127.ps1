...
param(
    [string]$ZipPath='D:\SOODALLIFE\SoodalLife-ProviderAdDualPreview-20260824-v127.zip',
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases',
    [switch]$ConfirmProductionDeployment
)
$ErrorActionPreference='Stop'
$expectedSha256='EF91BE5C4B150B703C49AE52BCF5CF0D35FCE27B19CC88BC3F94B27654F96BAD'
...
$extractPath=Join-Path $ReleaseBasePath "provider-ad-dual-preview-v127-$stamp"
...
Write-Host "2/4 Extracted V127 deployment validated: $release"
Write-Host '3/4 Running protected partner backup and IIS deployment.'
...
Write-Host '4/4 V127 provider advertising dual preview deployment completed.' -ForegroundColor Green
