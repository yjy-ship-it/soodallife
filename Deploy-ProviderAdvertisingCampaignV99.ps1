[CmdletBinding()]
param(
    [string]$ZipPath = 'D:\SOODALLIFE\SoodalLife-ProviderAdvertisingCampaign-20260819-9705638-v99.zip',
    [string]$ReleaseBasePath = 'D:\SOODALLIFE\releases'
)

$ErrorActionPreference = 'Stop'
$expectedSha256 = '34045BD1ED6DE6970F08A396A0985892A1BCD561E82995B7DE6A91525A6C9F01'
...
$extractPath = Join-Path $ReleaseBasePath "provider-advertising-campaign-v99-$stamp"
...
$requiredFiles = @(
    ...
    (Join-Path $releasePath 'deployment\Apply-ProviderAdvertisingCampaignV99.sql'),
    (Join-Path $releasePath 'deployment\Verify-ProviderAdvertisingCampaignV99.sql')
)
...
Write-Host 'Next: verify rates, provider application, admin rejection/resubmission/approval/publication, and wallet ledger.'
