...
param(
    [string]$ZipPath='D:\SOODALLIFE\SoodalLife-AutonomousMarketplaceOperations-20260827-v146.zip',
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases',
    [switch]$ConfirmProductionDeployment
)
$ErrorActionPreference='Stop'
$expectedSha256='33AECF8786E39685EC1E4EE0B6915A90F0795B74895C9D7CE46962F8AF185AE9'
...
$extractPath=Join-Path $ReleaseBasePath "autonomous-marketplace-operations-v146-$stamp"
...
Write-Host "2/4 Extracted V146 deployment validated: $release"
Write-Host '3/4 Running protected API, customer, partner and admin backup followed by IIS deployment.'
...
Write-Host '4/4 V146 autonomous marketplace operations deployment completed.' -ForegroundColor Green
