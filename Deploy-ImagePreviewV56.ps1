[CmdletBinding()]
param(
    [string]$ZipPath = 'D:\SOODALLIFE\SoodalLife-ImagePreview-20260818-2e647b5-v56.zip',
    [string]$ReleaseBasePath = 'D:\SOODALLIFE\releases'
)

$ErrorActionPreference = 'Stop'
$expectedSha256 = '441385C0BB3DD04771107B569F2F422E80C0D4B9BA3C34D8932A54A679D9235C'
...
$extractPath = Join-Path $ReleaseBasePath "image-preview-v56-$stamp"
...
Write-Host 'Next: hard refresh and verify provider profile images and customer/provider request attachment previews.'
