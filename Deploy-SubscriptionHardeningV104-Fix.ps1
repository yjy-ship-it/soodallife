[CmdletBinding()]
param(
    [string]$ZipPath='D:\SOODALLIFE\SoodalLife-SubscriptionHardening-20260819-9705638-v104.zip',
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases'
)
$ErrorActionPreference='Stop'
$expectedSha256='AC84E8257DFB480EA17E23D747912A54A7200985AA0D5C38A8A11FA524DAB9EC'
...
$stamp=Get-Date -Format 'yyyyMMdd-HHmmss';$extractPath=Join-Path $ReleaseBasePath "subscription-hardening-v104-$stamp";if(Test-Path -LiteralPath $extractPath){throw "Extraction directory already exists: $extractPath"};New-Item -ItemType Directory -Path $extractPath|Out-Null
