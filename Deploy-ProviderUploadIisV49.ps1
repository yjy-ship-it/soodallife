[CmdletBinding()]
param(
    [string]$ZipPath = 'D:\SOODALLIFE\SoodalLife-ProviderUploadIis-20260817-2e647b5-v49.zip',
    [string]$ReleaseBasePath = 'D:\SOODALLIFE\releases'
)

$ErrorActionPreference = 'Stop'
$expectedSha256 = '2F035F068907845845310C9C0961058CA97904E85797AA790B412E83F70C5F9E'
...
$extractPath = Join-Path $ReleaseBasePath "provider-upload-iis-v49-$stamp"
