[CmdletBinding()]
param(
    [string]$ZipPath = 'D:\SOODALLIFE\SoodalLife-ProviderTrust-20260817-2e647b5-v47.zip',
    [string]$ReleaseBasePath = 'D:\SOODALLIFE\releases'
)

$ErrorActionPreference = 'Stop'
$expectedSha256 = 'D980FECC993517EAB5F34431B2504C4ED77893662D26FC705E59DFBFE93C2DDD'
...
$extractPath = Join-Path $ReleaseBasePath "provider-trust-v47-$stamp"
...
Write-Host 'Next: verify the header trust badge, trust history and grades, API health and readiness.'
