[CmdletBinding()]
param(
    [string]$ZipPath = 'D:\SOODALLIFE\SoodalLife-ProviderImageResilient-20260818-2e647b5-v53.zip',
    [string]$ReleaseBasePath = 'D:\SOODALLIFE\releases'
)

$ErrorActionPreference = 'Stop'
$expectedSha256 = '629B6031352C6C795D281DE41B538FF22B49F22216BEBEA646C3D6055EBF2FBD'
...
$extractPath = Join-Path $ReleaseBasePath "provider-image-resilient-v53-$stamp"
...
Write-Host 'Next: hard refresh and verify resilient logo/photo upload, API health and readiness.'
