[CmdletBinding()]
param(
    [string]$ZipPath = 'D:\SOODALLIFE\SoodalLife-ProviderUx-20260817-2e647b5-v44.zip',
    [string]$ReleaseBasePath = 'D:\SOODALLIFE\releases'
)

$ErrorActionPreference = 'Stop'
$expectedSha256 = '3016C289C89F816FE3B403205C2BDF632684028DD7C3144AE69C422C4E9A84DB'
...
$extractPath = Join-Path $ReleaseBasePath "provider-ux-v44-$stamp"
