...
param(
    [string]$ZipPath='D:\SOODALLIFE\SoodalLife-CareAutonomousOperations-20260825-v142.zip',
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases',
    [switch]$ConfirmProductionDeployment
)
$ErrorActionPreference='Stop'
$expectedSha256='4962842959DA726E6B6243064AA5FF4D334903F76966F515E107FF3EEB2D7680'
...
$extractPath=Join-Path $ReleaseBasePath "care-autonomous-operations-v142-$stamp"
...
Write-Host "2/4 Extracted V142 deployment validated: $release"
...
Write-Host '4/4 V142 care autonomous operations deployment completed.' -ForegroundColor Green
