...
param(
    [string]$ZipPath=(Join-Path $PSScriptRoot 'SoodalLife-ProviderAreaSaveReliability-20260828-v153.zip'),
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases',
    [switch]$ConfirmProductionDeployment
)
$ErrorActionPreference='Stop'
$expectedSha256='0CBEA36E4953DC9322DCA6CEF808FC3018FE2CD9DAB9CA0047FD267BFD86110B'
...
$extractPath=Join-Path $ReleaseBasePath "provider-area-save-reliability-v153-$stamp"
...
Write-Host "2/4 Extracted V153 deployment validated: $release"
...
Write-Host '4/4 V153 provider area save reliability deployment completed.' -ForegroundColor Green
