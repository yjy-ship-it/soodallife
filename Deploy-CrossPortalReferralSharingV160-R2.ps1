...
param(
    [string]$ZipPath=(Join-Path $PSScriptRoot 'SoodalLife-CrossPortalReferralSharing-20260830-v160-r2.zip'),
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases',
    [switch]$ConfirmProductionDeployment
)
$ErrorActionPreference='Stop'
$expectedSha256='42D20E2CD079551151311321D40A5413D0DBA6AAADB3EE8EA5CE3F604F603233'
...
$stamp=Get-Date -Format 'yyyyMMdd-HHmmss';$extractPath=Join-Path $ReleaseBasePath "cross-portal-referral-sharing-v160-r2-$stamp";New-Item -ItemType Directory -Path $extractPath|Out-Null
...
Write-Host "2/4 Extracted V160-R2 deployment validated: $release"
...
Write-Host '4/4 V160-R2 cross-portal navigation and friend sharing deployment completed.' -ForegroundColor Green
