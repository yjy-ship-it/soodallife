...
$home=Invoke-WebRequest -Uri 'https://partner.soodallife.kr/provider' -UseBasicParsing -TimeoutSec 30
if($notification.StatusCode -ne 200 -or $home.StatusCode -ne 200){throw 'Provider page verification failed.'}
