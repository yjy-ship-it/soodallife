...
param(
    [string]$ZipPath='D:\SOODALLIFE\SoodalLife-ProviderAdPreviewModal-20260823-v126.zip',
    [string]$ReleaseBasePath='D:\SOODALLIFE\releases',
    [switch]$ConfirmProductionDeployment
)
$ErrorActionPreference='Stop'
$expectedSha256='D676AA6009F08B89D3A1506ED964D7330EE515486C5DECE095D5F03DBA592396'
...
$extractPath=Join-Path $ReleaseBasePath "provider-ad-preview-modal-v126-$stamp"
...
Write-Host "2/4 Extracted V126 deployment validated: $release"
Write-Host '3/4 Running protected partner frontend backup and IIS deployment.'
...
Write-Host '4/4 V126 provider advertising preview modal deployment completed.' -ForegroundColor Green
